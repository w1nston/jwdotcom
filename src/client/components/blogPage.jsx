...
ln -nfs $RELEASE_DIR/$RELEASE $BASE_DIR"/latest";`
          ...
          <p>
            ...
            base directory for the site, and the release directory keeping all the different
            releases.
          </p>
          <p>
            It also generates a release number based on the date as well as a version number
            provided
          ...
          <p>
            The second part checks if there exists a release directory, otherwise it creates it,
            moves
            inside it and clones a new branch from the master branch specified at GitHub, then
            finally
            creates a symlink "latest" to the newly cloned release.
          </p>
          <h3>The new project structure</h3>
          <p>
            Now it is time to increase the complexity a bit, lets add a build step. For the heck of
            it
            is time to add some
            <a href="https://facebook.github.io/react/" target="_blank">
              React
            </a>
            <a href="https://react-router.now.sh/" target="_blank">et al.</a>
            {' '}
            to the mix.
          </p>
          <p>
...
`
          ...
          <p>
            ...
            Its configuration lives in a file (
          ...
          <p>
            ...
            {' '}
            property specifies the file(s) that are to be loaded as entry point for
            the
            bundle.
          </p>
          <p>
          ...
          <p>
            ...
            {' '}
            property specifies plugins to be used in order to work on the bundle. For instance
          ...
          <p>
            ...
            {' '}
            property specifies loaders to transform files. A loader is basically a function that
    ...
    loaders: [
      {
        ...
        query: {
          ...
          <p>
            ...
            , and if all passes, building the JavaScript to be used. Okay, let's go,
            .travis.yml!
          </p>
          <pre>
...
`
          ...
          <p>
            ...
            {' '}
            and pushing the .travis.yml file to Github, a step is still
          ...
          <p>
            ...
            I use the hot module replacement to get hot reloading for the react components, and
            since
          ...
          <p>
            ...
            <a href="http://bit.ly/2fuIDVL" target="_blank">
              add a plugin for webpack
            </a>
            {' '}
            to get React built for production rather than a development
            environment.
          </p>
          <pre>
            <code className="language-js">
...
`
          ...
          <p>
            ...
            have a script to revert to latest version in case of something breking with a new
            release.
          </p>
          ...
          <p>
            ...
            {' '}
            the best workaround seems to be to simply install the
...
| |-index.html`
          ...
          <p>
            ...
            <a target="_blank" href="https://github.com/w1nston/jwdotcom">
              Github
            </a>
            .
          </p>
          ...
          <p>
            ...
            <a target="_blank" href="https://nginx.org/en/">nginx</a>
          ...
          <p>
            ...
            {' '}
            <i>latest</i>
            -directory is simply a symbolic link pointing to
            another
...
latest -> 20160917/`
          ...
          <p>
            ...
            . The date part is not totally useless, but it needs a little more. Another type
...
...`
          ...
          <p>
            ...
            {' '}
            that got me thinking about a different structure. At first
